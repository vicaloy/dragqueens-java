...
import grafica.controladores.ControladorObtenerGanadora;
import grafica.controladores.ModeloDatosDragQueens;
import logica.valueObjects.VODragQueenVictorias;

public class ObtenerGanadora extends javax.swing.JFrame {

	private ModeloDatosDragQueens modeloTabla;
	private ControladorObtenerGanadora miControlador;

	public ObtenerGanadora() {
		getContentPane().setBackground(new Color(248, 248, 255));
		this.miControlador = new ControladorObtenerGanadora(this);
		initComponents();
	}
	...
	private void initComponents() {
		...
		btnListar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				VODragQueenVictorias ganadora = miControlador.listarGanadora((Integer) spinnerTemp.getValue());
				ArrayList<VODragQueenVictorias> listado = new ArrayList<VODragQueenVictorias>();
				if (ganadora != null) {
					listado.add(ganadora);
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ObtenerGanadora().setVisible(true);
			}
		});
	}
